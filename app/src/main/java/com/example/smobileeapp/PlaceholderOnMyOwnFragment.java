...
public class PlaceholderOnMyOwnFragment extends Fragment {
    ...
    public static PlaceholderOnMyOwnFragment newInstance(int sectionNumber, String onMyOwn, String userIdToken) {
        PlaceholderOnMyOwnFragment fragment = new PlaceholderOnMyOwnFragment();
        Bundle args = new Bundle();
        args.putInt(ARG_SECTION_NUMBER, sectionNumber); // 올바른 매개변수를 설정해야 함
        args.putString("userIdToken", userIdToken);
        args.putString("onMyOwn", onMyOwn);
                    ...
                    for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                        if (userSnapshot.getKey().equals(userIdToken)) {
                            for (DataSnapshot problemSnapshot : userSnapshot.getChildren()) {
                                ...
                                if (problem != null && problem.getProblemTitle() != null && onMyOwn != null && problem.getOnmyown().equals(onMyOwn)) {
