...
public class RProblemReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rproblem_reg);
    ...
    private void populateUI() {
        ...
        etProblemNum.setText(String.valueOf(problemNum));

        EditText etProblemTitle = findViewById(R.id.problemTitle);
        etProblemTitle.setText(problemTitle);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(RProblemReg.this, ProblemInfo.class);
