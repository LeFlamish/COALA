...
public class PlaceholderQTitleFragment extends Fragment {
    ...
    public PlaceholderQTitleFragment() {
    }

    public static PlaceholderQTitleFragment newInstance(int sectionNumber, String problemTitle, String userIdToken) {
        PlaceholderQTitleFragment fragment = new PlaceholderQTitleFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            problemTitle = getArguments().getString("problemTitle", problemTitle);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_placeholder_q_title, container, false);
        ListView listView = rootView.findViewById(R.id.question_list_view);

        // context가 null인지 확인하는 로그 추가
        if (context == null) {
            throw new NullPointerException("Context is null in PlaceholderQTitleFragment");
        }
